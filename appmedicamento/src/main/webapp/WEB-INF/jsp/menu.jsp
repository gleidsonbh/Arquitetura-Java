...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" href="#">AppMedicamento</a>
		</div>
		<ul class="nav navbar-nav">
			...
			<c:if test="${not empty user}">
				...
				<li class="nav-item"><a class="nav-link" href="/pedido/lista">Pedido</a>
				</li>
				...
				<li class="nav-item"><a class="nav-link"
					href="/medicamento/lista">Medicamento</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/higienepessoal/lista">Higiene Pessoal</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/dermocosmetico/lista">Dermocosmético</a></li>
			</c:if>					
		</ul>
